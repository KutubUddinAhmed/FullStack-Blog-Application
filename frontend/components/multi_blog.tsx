            ...
            (
              ...
              <Link href={`/blog/${blog.Slug}`}    key={i}>
               <div
                ...
                className="card dark:border-none border rounded-lg shadow-lg p-4 mb-4 mt-1 bg-white dark:shadow dark:shadow-white"
              >
  ...
  {right_blogs.map(
    (
      ...
      <Link href={`/blog/${rblogs.Slug}`} key={i}>
        ...
        className="blog-card bg-white shadow-lg rounded-lg overflow-hidden transform transition-transform hover:scale-[102%] border-2 border-black/20 dark:border-white/80 mx-3 my-1.5 min-h-[180px] py-3 grid place-content-center"
      >
