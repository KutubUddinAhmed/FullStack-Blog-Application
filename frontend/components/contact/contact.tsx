"use client";
import { contactFormData } from "@/actions/contactFormActions";
import { Button } from "../ui/button";
import { useRef } from "react";
function Contact() {
  const ref = useRef<HTMLFormElement | any>();
          ...
          <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 dark:border-neutral-700">
            ...
            >
              <div className="grid gap-4">
                ...
                <div>
                  <label htmlFor="feed_details" className="sr-only">
                    Details
                  </label>
                  <textarea
                    id="feed_details"
              ...
              <div className="mt-4 grid">
                <Button className="w-full py-5 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none dark:bg-black  dark:border-white/70">
                  Send Inquiry
                </Button>
              </div>
